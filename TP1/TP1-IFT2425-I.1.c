...
int sumFunction(int N, double s){
...
//implmentations du tableau contenant les valeurs de y
    ...
    yPuissanceC = pow(y,c);
    ln = log10(y);
    puissance = yPuissanceC * ln;
    
    somme1 = sumFunction(N,puissance);
    //printf("%f\n", somme1);
    somme2 = sumFunction(N,yPuissanceC);
    printf("%f\n", somme2);
    somme3 = sumFunction(N,ln);
